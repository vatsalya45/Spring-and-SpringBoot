...
public class BootIocProject5MiniProjectCoonectionWitMySQL {
	...
	public static void findEmployeeByDesg(String [] args) {
		...
		try (
			...
			ConfigurableApplicationContext ctx = SpringApplication.run(BootIocProject4MiniProject.class, args);
		...
		}//try--> At this the Object created in the try with resources block will be closed automatically 
		catch (Exception e) {
	...
	public static void registerEmployee(String [] args) {
		//get IOC container
		ApplicationContext ctx = SpringApplication.run(BootIocProject4MiniProject.class, args);
